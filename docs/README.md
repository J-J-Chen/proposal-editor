...
| [design-ui.md](design-ui.md) | The editor UI: the "familiar-not-clone" principle, the **conversational editing** surface (scope-by-selection, onboarding-first suggestions, back-and-forth review cards) and the "Assistant" foundation it grew from, confirmed UX decisions, tokens. |
