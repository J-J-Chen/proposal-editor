...
| [design-ui.md](design-ui.md) | The editor UI: the "familiar-not-clone" principle, the shipped "Assistant" direction + its **evolution into conversational editing** (scope-by-selection, onboarding-first suggestions, back-and-forth review cards), confirmed UX decisions, tokens. |
